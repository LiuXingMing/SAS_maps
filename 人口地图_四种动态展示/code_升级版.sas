...
/* 画全国地图 */
ODS LISTING CLOSE;
ODS HTML path = "&file_dir.\Temp" body = "main.htm" style=htmlblue;
...
%macro drow_provinces(ID);
	...
	title1 ls=2.0 h=12pct c=red f="/bold" "&&&myNAMEs.."
			c = black j = r alt = "返回" link="file:///&file_dir./Temp/main.htm" ls = 0 h = 9 font = "Cumberland AMT/bold"  "×";
	...
	ODS LISTING CLOSE;
	ODS HTML path="&file_dir.\Temp" body="&ID..htm" (title="Costa Rican vacation! (SAS/Graph gmap)")
